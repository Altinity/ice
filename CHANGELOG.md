...
## [0.23.0](https://github.com/Altinity/ice/compare/v0.22.0...master)

### Added
- `ice` - Added logic to create table from schema. ([#219](https://github.com/Altinity/ice/pull/219))
...
- `ice` - Add support for native ice binary using graalvm ([#42](https://github.com/Altinity/ice/pull/42))
- `ice` - Support for buffering inserts ([#211](https://github.com/Altinity/ice/pull/211))

## [0.20.0](https://github.com/Altinity/ice/compare/v0.20.0...v0.19.0)

### Fixed

- `ice-rest-catalog` - Fix catalog maintenance with empty namespace and document configuration ([#207](https://github.com/Altinity/ice/pull/207))
